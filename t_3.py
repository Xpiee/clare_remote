...
for comb in num_combinations:
    ...
    #             wgt = {0:round(class_wgt[0], 2), 1: round(class_wgt[1], 2), 2: round(class_wgt[2], 2)}
        ...
        model = mega_model.multimodal_classifier1(input_shape=in_shape, classes=num_classes, modality_names=mod_names)
        mod_1 = inspect.getsource(mega_model.multimodal_classifier1)
