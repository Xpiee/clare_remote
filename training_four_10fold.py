...
num_combinations = ['ecg_gze', 'eda_gze', 'eeg_gze', 'ecg_eda_gze', 'ecg_eeg_gze', 'eda_eeg_gze', 'ecg_eda_eeg_gze']
...
for comb in num_combinations:
    ...
    if comb == 'ecg_gze':
        ...
        mod1, mod2, lab1 = support_functions.data_folds.make_data(mod1, mod2, sub_label_ecg, num_modality=1)
